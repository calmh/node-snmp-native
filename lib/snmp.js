...
// Shortcut to get all OIDs in the `oids` array sequentially, while calling
// the registered callback for each. Prime candidate for GetBulk in the future.

Session.prototype.getAll = function (oids, callback) {
    var self = this, pkts = [];
